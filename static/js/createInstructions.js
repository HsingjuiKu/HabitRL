...
const CONTINUE = '<p class="continue" style="text-align: center;"><br/>[Press SPACE to continue]</p>'; // instruction page footer
...
const createInstructions1 = function() {
  ...
  instrTimeline.push({
    ...
    stimulus: '<h3>Instruction 1/6</h3>'
    + '<p>'
  ...
  instrTimeline.push({
    type: jsPsychHtmlKeyboardResponse,
    stimulus: '<h3>Instruction 2/6</h3>'
    + '<p>'
  ...
  instrTimeline.push({
    type: jsPsychHtmlKeyboardResponse,
    stimulus: '<h3>Instruction 3/6</h3>'
    + '<p>'
  ...
  instrTimeline.push({
    type: jsPsychHtmlKeyboardResponse,
    stimulus: '<h3>Instruction 4/6</h3>'
    + '<p>'
  ...
  instrTimeline.push({
    type: jsPsychHtmlKeyboardResponse,
    stimulus: '<h3>Instruction 5/6</h3>'
    + '<p>'
